...
<div className="container">
    ...
    <div className="comparison-nav">
      ...
      />
        ...
        <Button  className="comparsionPlus" variant="contained" disableElevation>
        Add products
    </Button>
    
      
        </div>
        <span className='differences'> <PinkSwitch {...label} defaultChecked /> Only differences
        </span>
...
<div className="table-comparsion">
