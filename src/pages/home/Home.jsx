...
<div className="section1_nav">
  ...
  <button>Посмотреть все <GoArrowRight/></button>
</div>
...
<Card/>
  ...
  loop={true}
        ...
        className="mySwiper"
      >
<SwiperSlide><div className="boxCategory">
  <h4>
  Компьютеры
  </h4>
  <img src="https://abzzvx.pythonanywhere.com/media/images/camputer.png" alt="" />
</div></SwiperSlide>
<SwiperSlide><div className="boxCategory">
  <h4>
  Компьютеры
...
<SwiperSlide><div className="boxCategory">
  ...
  <img src="https://abzzvx.pythonanywhere.com/media/images/camputer.png" alt="" />
</div></SwiperSlide><SwiperSlide><div className="boxCategory">
  <h4>
  Компьютеры
  </h4>
  <img src="https://abzzvx.pythonanywhere.com/media/images/camputer.png" alt="" />
...
<SwiperSlide><div className="boxCategory">
  ...
  <img src="https://abzzvx.pythonanywhere.com/media/images/camputer.png" alt="" />
      ...
      <div className="product-info">
        ...
        Совершенно новый дисплей Super Retina с диагональю 5,8 дюйма, который удобно лежит в руке и потрясающие выглядит, — это и есть iPhone X.
        </p>
      </div>
